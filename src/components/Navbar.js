      ...
      <div className="flex items-center w-full">
        ...
        <div className="flex-1 flex ml-8 space-x-8 text-xl">
          ...
          <div className="relative">
            ...
            >
              Indonesian (ID) <span className="ml-1">▼</span>
            </button>
            {dropdownOpen && (
        ...
        <div className="flex items-center justify-end space-x-4">
          <div className="bg-white p-2 rounded-full cursor-pointer hover:bg-gray-200">
            <Image src="/svg/Visibility.svg" alt="Visibility Icon" width={24} height={24} />
          </div>
          <div className="bg-white p-2 rounded-full relative cursor-pointer hover:bg-gray-200">
            <Image src="/svg/bell.svg" alt="Notification Icon" width={24} height={24} />
          ...
          <div className="bg-white p-2 rounded-full cursor-pointer hover:bg-gray-200">
            <Image src="/svg/settings.svg" alt="Settings Icon" width={24} height={24} />
          </div>
          <div className="relative ml-4">
            <Image src="/profile.png" alt="User Avatar" width={40} height={40} className="rounded-full" />
            <span className="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full px-2">
              377
            </span>
          </div>
